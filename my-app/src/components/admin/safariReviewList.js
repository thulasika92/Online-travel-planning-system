...
import { deleteReviews, getReviews } from "../../actions/safariAction";
import { clearError, clearReviewDeleted } from "../../slices/safariSlice";

export default function SafariReviewList() {
    const { reviews = [], loading = true, error, isReviewDeleted = false } = useSelector(state => state.safariState);
    ...
    const deleteHandler = (e, id) => {
        ...
        dispatch(deleteReviews(safariId, id))
    }

    const submitHandler = (e) => {
        e.preventDefault();
        dispatch(getReviews(safariId))
    }
    ...
    return (
        <div className="row">
            ...
            <div className="col-12 col-md-10">
                <h1 className="my-4">Safari Review List</h1>
                <div className="row justify-content-center mt-5">
                    <div className="col-5">
                        <form onSubmit={submitHandler}>
                            <div className="form-group">
                                <label><b>Safari Id</b></label>
                                <input
                                    type="text"
